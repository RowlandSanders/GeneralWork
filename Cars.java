...
public class Cars {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "auto_body_style_name",  nullable = false)
    ...
    public Cars(Owners owner, auto_body_styles name, String VIN, String manufacturer, String model, int years){
        this.setOwner(owner);
        this.setName(name);
        this.setVIN(VIN);
