...
public class CarClub {
   ...
   public static void main(String[] args) {
      ...
      owners.add(new Owners("White", "Ryan", "562-882-2898"));
      owners.add(new Owners("Greg", "Bob", "562-782-2897"));
      ...
      car.add(new Cars(owners.get(0), carclub.getStyle("sedan"), "1FTPW14504KC36912", "Honda", "Accord", 2018));
      car.add(new Cars(owners.get(0), carclub.getStyle("sport-utility vehicle"), "1J8HS58N98C164327", "Dodge", "Durango", 2003));
      car.add(new Cars(owners.get(1), carclub.getStyle("sedan"), "1HGCM55327A016935", "Toyota", "Camry", 2014));
      car.add(new Cars(owners.get(1), carclub.getStyle("sport-utility vehicle"), "1GCHK29D27E167102", "Honda", "Pilot", 2021));
      car.add(new Cars(owners.get(2), carclub.getStyle("sedan"), "3C4PDDBG2CT340424", "Honda", "Civic", 2013));
      car.add(new Cars(owners.get(2), carclub.getStyle("coupe"), "1J4GK48K64W191670", "Chevrolet", "Camero", 2004));
      car.add(new Cars(owners.get(3), carclub.getStyle("sport-utility vehicle"), "WBAEV33434KL00856", "Ford", "Bronco", 2002));
      car.add(new Cars(owners.get(3), carclub.getStyle("coupe"), "WDBRF61J21F021056", "Subaru", "WRX", 2016));
      car.add(new Cars(owners.get(4), carclub.getStyle("sedan"), "1FTFW1CV6AFC20053", "Acura", "TL", 2005));
      car.add(new Cars(owners.get(4), carclub.getStyle("pickup truck"), "1FMZU77E22UC18440", "Ford", "F-150", 2011));

      carclub.createEntity (car);
